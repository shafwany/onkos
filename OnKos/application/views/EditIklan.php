...
<body>
    <div>
        ...
        <div class="border-bottom">
            <form class="rounded my-4" method="POST" action="<?php echo base_url().'index.php/editiklan/editData/'.$d["idKosan"]; ?>">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="idIbu" disabled="" value="<?php echo $d['idIbuKos'] ?>">
                    </div><!--form group id kos-->
                    <div class="form-group col-md-12">
                        <label>ID Kosan</label>
                        <input type="text" class="form-control" name="id" value="<?php echo $d['idKosan']; ?>" disabled>
                    </div><!--form group id kos-->
                    <div class="form-group col-md-12">
                        <label>Nama Kosan</label>
                        <input type="text" class="form-control" name="Nama" value="<?php echo $d['namaKosan']; ?>">
                    </div><!--form group nama kos-->
                    <div class="form-group col-md-12">
                        <label>Alamat</label>
                        <input type="text" class="form-control" name="Alamat" value="<?php echo $d['alamatKosan']; ?>">
                    ...
                    <div class="form-group col-md-12">
                        <label>Harga</label>
                            <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="contoh : 1000000" name="Harga" value="<?php echo $d['harga']; ?>">                                  
                            </div>
                    </div><!--form group harga-->
                    <div class="form-group col-md-12">
                        <label>Deskripsi</label>
                        <input type="text" class="form-control" name="Deskripsi" value="<?php echo $d['deskripsi']; ?>">
                    </div><!--form group deskripsi-->
                    <div class="form-group col-md-12">
                        <label>Fasilitas Kamar</label>
                        <div id="fasKmr">
                            <input type="text" class="form-control" name="fasKmr" value="<?php echo $d['fasKamar']; ?>">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="contoh : 4x5" name="Luas" value="<?php echo $d['luasKamar']; ?>">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div id="fasUmum">
                            <input type="text" class="form-control" name="fasUmum" value="<?php echo $d['fasUmum']; ?>">
                    ...
                    <div class="form-group col-md-12">
                        <label>Parkir</label>
                        <div id="park">
                            <input type="text" class="form-control" name="Parkir" value="<?php echo $d['parkir']; ?>">
